...
- No existing AI context artifacts were detected.
...
4. Treat `.ai-os/context/*.md` files as source-of-truth and update them after architectural changes.
