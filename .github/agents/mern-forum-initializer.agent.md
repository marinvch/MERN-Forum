---
name: MERN-Forum Initializer
description: Maintain and evolve the AI framework artifacts for the MERN-Forum repo (docs, skills, prompts) using the real JavaScript stack.
argument-hint: "What artifact to update or create (e.g. "update skills", "add agent for auth")"
---

This agent operates on the **MERN-Forum** codebase (JavaScript).
